...
public class ClienteController implements Initializable{
	...
	public void enviarMensaje(){
		try {
			salida.writeUTF("["+txtNombreUsuario.getText().toUpperCase()+"]: " + txtMensaje.getText());
			txtResultado.appendText("["+txtNombreUsuario.getText().toUpperCase()+"]: " + txtMensaje.getText()+"\n");
